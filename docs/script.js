...
const quizData = {
  ...
  result_1: {
    location: "①矢場南",
    items: "ゴミ袋に入る可燃物 (紙類、木屑、ガムテープ、ビニール袋、養生テープ、着色のあるペットボトル、養生付き広告ボーン、残っていないテープ)", // itemsの文言を少し汎用的に変更
    notes: "※ゴミ袋は各自で用意してください。

【ゴミ袋について】
・プラスチック類（ガムテープ、ビニール袋、養生テープ、着色のあるペットボトル、養生付き広告ボーン）は、必ず市指定のゴミ袋に入れて捨ててください。
・プラスチック類でないゴミ（紙類、木屑、残っていないテープ）は、市指定のゴミ袋でなくても構いません。",
